...
{cmd:help nwhomophily}
{hline}

{title:Title}

{p2colset 5 20 22 2}{...}
{p2col :nwhomophily {hline 2}}Generate a homophilious network{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:nwhomophily} generates a homophilious network using {help nwdyadprob}. Each 
